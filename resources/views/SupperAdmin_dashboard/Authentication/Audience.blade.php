    ...
    <div class="container mx-auto px-4 py-6 min-h-screen">
        <div class="bg-white rounded-lg shadow-md h-[calc(100vh-8rem)]">
            <div class="p-4 border-b border-gray-200 flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-800">Audience Management</h2>
                        ...
                        @if ($users)
                            @foreach ($users as $user)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-500 capitalize">{{ $user->level ?? 'User' }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-3">
                                            ...
                                            <form style="display:inline;"
                                                action="{{ route('audience.destroy', $user->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
        ...
        function openEditDrawer(userId) {
            ...
            fetch(`/audience/${userId}/edit`)
                ...
                .then(user => {
                    ...
                    // Set form action
                    document.getElementById('editUserForm').action = `/audience/${userId}`;
