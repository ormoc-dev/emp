...
@section('content')
    ...
    <ul class="hidden text-sm font-medium text-center text-gray-500 rounded-lg shadow sm:flex  dark:text-gray-400 mb-4">
        ...
        <li class="w-full focus-within:z-10">
            <a class="inline-block w-full p-4 text-gray-900 bg-gray-100 border-r border-gray-200 dark:border-gray-700 rounded-s-lg focus:ring-4 focus:ring-blue-300 active focus:outline-none dark:bg-gray-700 dark:text-white"
                href="{{ route('selectS.event') }}"><span class="box_hand"> <i
    ...
    @if (session('success'))
        <div class="flex items-center p-4 mb-8 mt-3 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
    ...
    <div class="md:flex space-x-4">
        ...
        <div class="flex-1 p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
                        ...
                        <div class="md:col-span-1">
                            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                <form class="space-y-6" method="POST"
                                    ...
                                    <!-- Category Name -->
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2" for="category_name">
                                            Category Name
                                        </label>
                                        <input
                                    ...
                                    <!-- Category Icon -->
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2" for="category_icon">
                                            Category Icon
                                        </label>
                                        <select
                                    ...
                                    @forelse ($votingCategories as $category)
                                        <div class="p-4 flex items-center justify-between hover:bg-gray-50 transition-colors duration-150"
                                            ...
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <div>
                                                    <h5 class="font-medium text-gray-800">{{ $category->category_name }}
                                                    </h5>
                        ...
                        <div class="py-6">
                            <form class="space-y-6" id="voting-settings-form">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-gray-500">Set the maximum number of votes allowed per user</p>
                                </div>
            ...
            <div class="tab-content" id="rounds-content" style="display: none;">
                ...
                <div class="w-full">
                    <form class="max-w-full mx-auto" method="POST" action="{{ route('rounds.updateDescription') }}">
                        @csrf
                                ...
                                <tr class="border-b dark:border-gray-600">
                                    ...
                                    <td class="p-2 flex gap-2">
                                        <form id="deleteForm-{{ $criterion->id }}"
                                            action="{{ route('criteria.destroy', $criterion->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button class="bg-red-500 hover:bg-red-700 text-white px-2 py-1 rounded-sm"
