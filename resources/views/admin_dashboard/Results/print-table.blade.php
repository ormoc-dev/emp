...
<html lang="en">
    ...
    <body>
        <div class="clearfix header">
            <img class="logo" src="{{ asset('img/wlc.jpg') }}" alt="Left Logo">
            ...
            <img class="logo right" src="{{ asset('img/cicte-logo.png') }}" alt="Right Logo">
        </div>
        ...
        <script>
            ...
            // Close the tab after printing when opened via target=_blank
