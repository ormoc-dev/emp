...
@section('content')
    ...
    <div class="head-title">
        ...
        <a href="#" class="btn-download">
            <i class="bx fa-solid fa-download"></i>
    ...
    <ul class="box-info">
        <li>
            <i class="bx fa-regular fa-calendar-days"></i>
            <span class="text">
                <h3>{{ $eventsCount }}</h3>
                <p>Events</p>
        ...
        <li>
            <i class="bx fa-solid fa-people-line"></i>
            <span class="text">
                <h3>{{ $contestantsCount }}</h3>
                <p>Contestants</p>
            </span>
        </li>
        <li>
            <i class="bx fa-solid fa-heart"></i>
            <span class="text">
                <h3>{{$usersCount}}</h3>
                <p>Voters</p>
            </span>
...
,
             ...
             <i class="fa-solid fa-sort-down"></i>
                <div id="filterDropdown" style="display: none;">
                    <form action="{{ route('admin_home') }}" method="GET" class="text-black">
                        <select name="status">
                            <option value="">Filter by Status</option>
                            <option value="pending">Pending</option>
                            <option value="started">Started</option>
                        </select>
                        <button type="submit"><i class='bx bx-filter-alt text-green-500'></i></button>
                    </form>
                </div>
                ...
                <tbody>
                    @foreach ($events as $event)
                        <tr>
                            ...
                            <td>
                                <span class="status {{ $event->event_status === 'pending' ? 'pending' : 'start' }}">
                                    {{ $event->event_status }}
                                </span>
                            </td>
        ...
        <div class="max-w-sm w-full rounded-lg shadow p-4 md:p-6">
            <div class="flex justify-between items-start w-full">
                <div class="flex-col items-center">
                    <div class="flex items-center mb-1">
                        <h5 class="text-xl font-bold me-1">Event Data</h5>
                ...
                <div class="flex justify-end items-center">
                    <button id="widgetDropdownButton" data-dropdown-toggle="widgetDropdown"
                        ...
                        class="inline-flex items-center justify-center  hover:bg-gray-100  rounded-lg text-sm"><svg
            ...
            <script>
                const pendingEvents = {!! json_encode($pendingEvents) !!};
                const contestantsCount = {{ $contestantsCount }};
                const eventCounts = {{ $eventsCount }};
            </script>
            ...
            <button id="dropdownDefaultButton" data-dropdown-toggle="lastDaysdropdown" data-dropdown-placement="bottom"
                class="text-sm font-medium text-center inline-flex items-center " type="button">
                Last 7 days
