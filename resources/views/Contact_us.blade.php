                ...
                <div class="p-4 lg:w-1/2">
                    <div
                        ...
                        <div class="flex-grow sm:pl-8">
                            ...
                            <p class="mb-4">Anthony Capuyan is a skilled programmer and mobile application developer with
                                expertise in developing software solutions. He specializes in writing code and developing
                ...
                <div class="p-4 lg:w-1/2" >
                    <div
                        ...
                        <div class="flex-grow sm:pl-8">
                            ...
                            <p class="mb-4">Myreen Barro is responsible for documenting project processes and outcomes. As
                                a documentarist, she captures key moments, milestones, and learnings to create comprehensive
                                records.</p>
                            <span class="inline-flex">
                                <a class="text-gray-500 hover:text-gray-700" href="https://web.facebook.com/myreen.barro">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                    </svg>
                ...
                <div class="p-4 lg:w-1/2">
                    <div
                        ...
                        <div class="flex-grow sm:pl-8">
                            ...
                            <h3 class="text-gray-500 mb-3">Documentaries</h3>
                            <p class="mb-4">Angelo Conos is responsible for documenting project processes and outcomes.
                ...
                <div class="p-4 lg:w-1/2">
                    <div
                        ...
                        <div class="flex-grow sm:pl-8">
                            ...
                            <p class="mb-4">Jojo Cantero serves as an adviser, providing valuable insights and guidance to
                            ...
                            <span class="inline-flex">
                                <a class="text-gray-500 hover:text-gray-700" href="https://web.facebook.com/jojo.e.cantero">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                    </svg>
...
<section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
            <h1 class="text-2xl font-medium title-font mb-4 text-gray-900 animate-grow">FRAMEWORKS & TECHNOLOGIES</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base animate-slideIn ">Our project leverages a powerful
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                        ...
                        <p class="mb-4 animate-slideIn">A powerful PHP framework for web application development,
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                        ...
                        <p class="mb-4 animate-slideIn">A utility-first CSS framework for rapidly building custom user
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                        ...
                        <p class="mb-4 animate-slideIn">An open-source relational database management system known for
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                        ...
                        <p class="mb-4 animate-slideIn">A versatile programming language that enables interactive and
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                        ...
                        <p class="mb-4 animate-slideIn">Google's UI toolkit for building natively compiled applications
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                        ...
                        <p class="mb-4 animate-slideIn">The fundamental languages for structuring and styling web
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                        ...
                        <p class="mb-4 animate-slideIn">A platform for developing, shipping, and running applications
            ...
            <div class="p-4 lg:w-1/4 md:w-1/2">
                <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                        ...
                        <p class="mb-4 animate-slideIn">A next-generation frontend build tool that significantly
